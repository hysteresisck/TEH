  ...
  render() {
    ...
    return <div>
        ...
        <div className="bg-grey-1 pv4">
          <div className="flex-l mhn1-l ph3 center mw8">
            <h2 className="f2 b lh-title mb2 w-100-l">{entry.getIn(["data", "blurb", "heading"])}</h2>
        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="tc">
              <a href="/contact" className="btn raise">See all products</a>
            </div>
          </div>
        </div>
          ...
          <div className="ph3 mw7 center">
            ...
            <div className="flex-l mhn2-l">
              ...
              <div className="w-60-l ph2-l">
                <img src="/img/Team.png" alt="" className="mb3"/>
              </div>
            </div>

            <div className="tc">
              <a href="{{https://www.linkedin.com/company/the-entrepreneurial-hour/?viewAsMember=true}}" className="btn raise">Read more</a>
            </div>
